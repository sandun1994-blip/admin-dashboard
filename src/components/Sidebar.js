...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg  text-red-500  text-md m-2';
      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          ...
          <TooltipComponent content='Menu' position='BottomCenter'>
            <button type='button' onClick={() => { setActiveMenu(pre=>!pre)}} className='text-xl rounded-full 
